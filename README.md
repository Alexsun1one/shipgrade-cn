...
真正准备训练或蒸馏前,还需要可判分的评测集。发布包会把这些真实任务样本导出为 JSONL eval corpus,每条包含 prompt、repo/revision/license、证据路径、rubric、must_include、must_avoid、chosen/rejected answer,并用确定性 scorer 证明 chosen 4/4 通过、rejected 4/4 被拒绝。
