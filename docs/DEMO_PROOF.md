...
```text
shipgrade-demo-ok
target=$TMP/shipgrade-demo-project-kl1oz7g_
...
fake_rejection=$TMP/shipgrade-demo-project-kl1oz7g_/fake-completion.md: ship-grade-fail vague_or_unverified_language missing_concrete_artifact_path missing_command_or_browser_evidence
accepted=$TMP/shipgrade-demo-project-kl1oz7g_/accepted-handoff.md: ship-grade-ok
next=open $TMP/shipgrade-demo-project-kl1oz7g_/.shipgrade/task-brief.md
cleaned=true
```
