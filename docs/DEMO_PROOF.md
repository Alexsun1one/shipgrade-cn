...
```text
shipgrade-demo-ok
target=$TMP/shipgrade-demo-project-wmfei0ej
...
fake_rejection=$TMP/shipgrade-demo-project-wmfei0ej/fake-completion.md: ship-grade-fail vague_or_unverified_language missing_concrete_artifact_path missing_command_or_browser_evidence
accepted=$TMP/shipgrade-demo-project-wmfei0ej/accepted-handoff.md: ship-grade-ok
next=open $TMP/shipgrade-demo-project-wmfei0ej/.shipgrade/task-brief.md
cleaned=true
```
