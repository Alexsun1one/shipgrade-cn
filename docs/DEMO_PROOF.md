...
```text
shipgrade-demo-ok
target=$TMP/shipgrade-demo-project-mw2cdcrr
...
fake_rejection=$TMP/shipgrade-demo-project-mw2cdcrr/fake-completion.md: ship-grade-fail vague_or_unverified_language missing_concrete_artifact_path missing_command_or_browser_evidence
accepted=$TMP/shipgrade-demo-project-mw2cdcrr/accepted-handoff.md: ship-grade-ok
next=open $TMP/shipgrade-demo-project-mw2cdcrr/.shipgrade/task-brief.md
cleaned=true
```
