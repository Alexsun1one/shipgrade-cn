...
```text
shipgrade-demo-ok
target=$TMP/shipgrade-demo-project-sfnrihh0
...
fake_rejection=$TMP/shipgrade-demo-project-sfnrihh0/fake-completion.md: ship-grade-fail vague_or_unverified_language missing_concrete_artifact_path missing_command_or_browser_evidence
accepted=$TMP/shipgrade-demo-project-sfnrihh0/accepted-handoff.md: ship-grade-ok
next=open $TMP/shipgrade-demo-project-sfnrihh0/.shipgrade/task-brief.md
cleaned=true
```
