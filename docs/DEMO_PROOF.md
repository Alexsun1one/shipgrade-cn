...
```text
shipgrade-demo-ok
target=$TMP/shipgrade-demo-project-dw95umlp
...
fake_rejection=$TMP/shipgrade-demo-project-dw95umlp/fake-completion.md: ship-grade-fail vague_or_unverified_language missing_concrete_artifact_path missing_command_or_browser_evidence
accepted=$TMP/shipgrade-demo-project-dw95umlp/accepted-handoff.md: ship-grade-ok
next=open $TMP/shipgrade-demo-project-dw95umlp/.shipgrade/task-brief.md
cleaned=true
```
