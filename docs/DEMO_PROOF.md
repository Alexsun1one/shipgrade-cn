...
```text
shipgrade-demo-ok
target=$TMP/shipgrade-demo-project-45nsg4pq
...
fake_rejection=$TMP/shipgrade-demo-project-45nsg4pq/fake-completion.md: ship-grade-fail vague_or_unverified_language missing_concrete_artifact_path missing_command_or_browser_evidence
accepted=$TMP/shipgrade-demo-project-45nsg4pq/accepted-handoff.md: ship-grade-ok
next=open $TMP/shipgrade-demo-project-45nsg4pq/.shipgrade/task-brief.md
cleaned=true
```
