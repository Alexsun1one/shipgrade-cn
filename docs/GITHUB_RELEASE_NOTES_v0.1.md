...
- Local GitHub publish preflight covers bilingual README onboarding, distillation-pipeline docs, generated Repo/Pattern/Task/Eval assets, `shipgrade_patterns.py`, `demo-proof`, fake-completion rejection, social preview dimensions, evidence manifest, workflow file, and secret/metadata scan.
...
- `shipgrade-demo-ok`
- `github-publish-preflight-ok checks=19`
